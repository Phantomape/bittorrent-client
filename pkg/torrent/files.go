...
// File : interface for a file. Multiple goroutines may access
...
// FileSystem : interface for a file system. A file system
// contains files.
...
// FileStore : a torrent file store. WritePiece should be
// called for full, verified pieces only;
